...
},{"./modules/dashboard/dashboard-controller":2,"angular-route/angular-route":3,"angular/angular":4}],2:[function(require,module,exports){
...
/**
 * @license AngularJS v1.3.0-build.2535+sha.876df04
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-build.2535+sha.876df04/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-build.2535+sha.876df04',    // all of these placeholder strings will be replaced by grunt's
